...
const AboutMeText = () => {
  return (
    <div className="flex flex-col md:items-start sm:items-center md:text-left sm:text-center">
      ...
      <p className="text-white">I’m Osama, a web developer with a passion for coding. I specialize in React and front-end development, helping
        clients build real-world projects and get modern web technologies. Outside of coding, I enjoy continuous learning and
